...
@CjService(name = "/channel/document/like")
public class PushChannelDocumentLike implements IFlowJob {
    ...
    public void flow(EventTask e, INetworkBroadcast broadcast) throws CircuitException {
        ...
        NetworkFrame frame = new NetworkFrame("likeDocument /netflow/channel gbera/1.0", bb);
        ...
        //先推送给创建者
        broadcastToCreator(broadcast, frame.copy(), creator, liker, e.interval());
