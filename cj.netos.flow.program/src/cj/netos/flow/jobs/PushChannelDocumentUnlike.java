...
@CjService(name = "/channel/document/unlike")
public class PushChannelDocumentUnlike implements IFlowJob {
    ...
    public void flow(EventTask e, INetworkBroadcast broadcast) throws CircuitException {
        ...
        String unliker = (String) e.parameter("unliker");
        ...
        NetworkFrame frame = new NetworkFrame("unlikeDocument /netflow/channel gbera/1.0", bb);
        ...
        //先推送给创建者
        broadcastToCreator(broadcast, frame.copy(), creator, unliker, e.interval());
