...
@CjService(name = "/geosphere/document/unlike")
public class PushGeoDocumentUnlike extends PushGeoFlowJobBase {
    ...
    public void flow(EventTask e, INetworkBroadcast broadcast) throws CircuitException {
        ...
        NetworkFrame frame = new NetworkFrame("unlikeDocument /geosphere/receptor gbera/1.0", bb);
